...
/**
 * This is the item provider adapter for a {@link projects.belfius.solver.BelfiusInspecSolver.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BelfiusInspecSolverPackage.Literals.DOMAIN__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BelfiusInspecSolverPackage.Literals.DOMAIN__INSPECTORS);
			childrenFeatures.add(BelfiusInspecSolverPackage.Literals.DOMAIN__INSPECTIONS);
			childrenFeatures.add(BelfiusInspecSolverPackage.Literals.DOMAIN__LOCATIONS);
			childrenFeatures.add(BelfiusInspecSolverPackage.Literals.DOMAIN__SUB_DOMAINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BelfiusInspecSolverPackage.Literals.DOMAIN__INSPECTORS,
				 BelfiusInspecSolverFactory.eINSTANCE.createInspector()));

		newChildDescriptors.add
			(createChildParameter
				(BelfiusInspecSolverPackage.Literals.DOMAIN__INSPECTIONS,
				 BelfiusInspecSolverFactory.eINSTANCE.createInspection()));

		newChildDescriptors.add
			(createChildParameter
				(BelfiusInspecSolverPackage.Literals.DOMAIN__LOCATIONS,
				 BelfiusInspecSolverFactory.eINSTANCE.createLocation()));

		newChildDescriptors.add
			(createChildParameter
				(BelfiusInspecSolverPackage.Literals.DOMAIN__SUB_DOMAINS,
				 BelfiusInspecSolverFactory.eINSTANCE.createDomain()));
	}
