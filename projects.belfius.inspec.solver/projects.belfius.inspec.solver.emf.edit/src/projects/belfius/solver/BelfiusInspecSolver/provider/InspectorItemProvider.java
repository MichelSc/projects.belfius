...
/**
 * This is the item provider adapter for a {@link projects.belfius.solver.BelfiusInspecSolver.Inspector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InspectorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inspector_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inspector_Name_feature", "_UI_Inspector_type"),
				 BelfiusInspecSolverPackage.Literals.INSPECTOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BelfiusInspecSolverPackage.Literals.INSPECTOR__INSPECTION_TIME_WINDOWS);
		}
	...
	public String getText(Object object) {
		String label = ((Inspector)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BelfiusInspecSolverPackage.Literals.INSPECTOR__INSPECTION_TIME_WINDOWS,
				 BelfiusInspecSolverFactory.eINSTANCE.createInspectionTimeWindow()));
	}
